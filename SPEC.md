...
T356|.|widen T330's enumeration past `*Pane`/`*Panel` — `KeybindingSettings` is referenced only by its own test, a THIRD naming the guard cannot see (V241: the unwired thing takes a new shape each time)|V241,V220

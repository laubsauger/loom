...
T358|.|an OFF|suspended preview CLEARS | MARKS its slot (V303) — ⊥ a retained frame masquerading as live. folds into T353|V303,V204,T353
...
T352|.|**LFO plot breathes** — auto-range recomputed per frame from the visible window makes a stable sine expand & contract. sticky range: expand fast, decay slow, | quantise (V296)|V296,T344
T353|.|**`P` = preview ON/OFF** (V297). off ⇒ ⊥ tile, ⊥ scheduling, ⊥ GPU work — & the button reflects the state. PIN moves to the context menu. amends V28b: `ui.preview` becomes the switch, pinning gets its own field|V297,V28b,V158

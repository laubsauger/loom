...
T425|.|**E24 Audio-Reactive Reaction-Diffusion — the CAPSTONE example.** owner supplied a TD walkthrough (Pao Olea) as the brief. DEPENDS: T414 (audio), T387 (substeps), T388 (compositional RD). the mapping, node by node:
...
T431|.|**feature-track RECORDER + offline replay plumbing** — the engine contract ACCEPTS a recorded frameIndex→AudioFeatures track today & NOTHING captures | feeds one. ∴ "render this performance offline" is ⊥ yet possible & T425's doc needs it|T414,T425,V352

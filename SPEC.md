...
T316|.|cross-node `op()` READ path — the seam is `ResolveParametersOptions`, & the COMPILER ! supply it too (from `validate.ts`'s callers), ⊥ the inspector alone. completes V148's round trip|V148,V61,V109

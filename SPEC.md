...
T375|~|diagnose & fix B47 — ONE decode answer ∀ preview tile, output node & viewer. instrument all 3 w/ a known-value texture & compare EXACT pixels; the fix ! be structural (1 path), ⊥ 3 paths agreeing by coincidence|V56,V57,B47

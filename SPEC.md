...
T347|.|**examples for the new capabilities** — the geometry, temporal & particle work has NONE. E8 slit-scan (T321), E9 particles (spawn+kill+group), E10 instanced geometry on a generator (grid|sphere → renderInstances). examples are how a user DISCOVERS a feature; unexampled capability is capability nobody finds|V88,V89

...
T351|.|**performance audit** — 45-55fps on a TINY network (owner). measure FIRST: React re-renders/frame, the 60Hz readout, the new value plots, preview scheduling, B18's every-texture-node-is-a-sink, & only then GPU. report WHERE the frame goes before changing anything|V286,V185,V158

...
T344|.|**value-node previews** — rolling plot of the channel over the last N frames + current number, ∈ the node body. LFO/Timer/Constant/Lag/Filter/Slope/Trigger/Mouse/Analyze. TD draws the CHOP curve & that is why a TD network reads @ a glance|V273,V275,V16

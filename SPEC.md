...
T308|.|**wire `classifyEdit`** (B26) — the recompile classifier has ⊥ production caller ∴ §V5 is UNENFORCED & every edit runs the whole compiler|V5,V21,V190,V178
T309|.|ONE patch-op union: generate `src/agent/schemas.ts`'s from the domain's, | a test proving them equal (V208)|V208,V66

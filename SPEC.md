...
V207: an invariant nothing REFERENCES is an invariant nobody is holding. audit: 40 of 222 are cited nowhere ∈ `src/`; 5 of those are claimed DONE by a §T row (V62a/T140, V98/T141, V180/T274-6, V189+V191/T288-9). citation ⊥ enforcement, but a rule the code never mentions is a decent proxy for "⊥ one was thinking about it".

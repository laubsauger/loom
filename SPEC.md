...
T348|.|`documents.ts::node()` MERGES `parameters` & `extra.parameters` instead of spreading (V281). E1-E7 predate the trap & currently pass only 1 of the 2|V281
T349|.|generate | check `examples/README`'s index against the catalogue (V282)|V282,V89

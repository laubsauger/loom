...
T410|.|**E16 Murmuration** — needs T401. generator → flock kernel → pointer-displace kernel → `renderInstances`, colour BY VELOCITY, `group` predicate culling strays @ draw. the SOP-chain showcase: proves points are a PIPELINE ⊥ a source-to-sink hop|T401,T333,T369

...
export const rampNode: NodeDefinition = {
  ...
  parameters: {
    ...
    phase: { type: "number", label: "Phase", default: 0, min: -1, max: 1, range: "cyclic" },
    period: {
      type: "number",
      label: "Period",
      default: 1,
...
export const circleNode: NodeDefinition = {
  ...
  parameters: {
    ...
    center: { type: "vector", size: 2, label: "Center", default: [0.5, 0.5], min: -2, max: 3, range: "soft" },
    radius: { type: "vector", size: 2, label: "Radius", default: [0.25, 0.25], min: 0, max: 4, range: "floor" },
    softness: {
      type: "number",
      label: "Softness",
      default: 0.005,
...
export const rectangleNode: NodeDefinition = {
  ...
  parameters: {
    mode: { type: "enum", label: "Mode", default: "fill", options: [...CIRCLE_MODE_OPTIONS] },
    center: { type: "vector", size: 2, label: "Center", default: [0.5, 0.5], min: -2, max: 3, range: "soft" },
    size: { type: "vector", size: 2, label: "Size", default: [0.25, 0.25], min: 0, max: 4, range: "floor" },
    roundness: {
      type: "number",
      label: "Roundness",
      default: 0,
